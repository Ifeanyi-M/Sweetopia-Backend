...
namespace BlueAlmond.Migrations
{
    ...
    [Migration("20230313192717_OrderHeaderandOrderDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueAlmond.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BlueAlmond.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueAlmond.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueAlmond.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BlueAlmond.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueAlmond.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueAlmond.Models.CartItem", b =>
                {
                    b.HasOne("BlueAlmond.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlueAlmond.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("BlueAlmond.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("BlueAlmond.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("BlueAlmond.Models.OrderHeader", b =>
                {
                    b.HasOne("BlueAlmond.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlueAlmond.Models.ApplicationUser", null)
                        .WithMany()
